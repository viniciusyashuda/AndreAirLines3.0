...
namespace PassengerMicroService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<PassengerDatabaseSettings>(
            Configuration.GetSection(nameof(PassengerDatabaseSettings)));
            services.AddSingleton<IPassengerDatabaseSettings>(sp =>
                sp.GetRequiredService<IOptions<PassengerDatabaseSettings>>().Value);
