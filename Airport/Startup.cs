...
namespace AirportMicroService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<AirportDatabaseSettings>(
            Configuration.GetSection(nameof(AirportDatabaseSettings)));
            services.AddSingleton<IAirportDatabaseSettings>(sp =>
                sp.GetRequiredService<IOptions<AirportDatabaseSettings>>().Value);
